...
export function EvervaultCardDemo() {
  return (
    <div className="border border-white/[0.4] dark:border-white/[0.2] flex flex-col items-start max-w-sm mx-auto p-4 relative h-[30rem] mt-5">
      ...
      <p className="text-sm border font-light dark:border-white/[0.4] border-white/[0.2] rounded-full mt-4 text-white dark:text-white px-2 py-0.5">
        Watch me hover
      </p>
    </div>
  );
